...
fun RssUnreadScreen(
    ...
    val unreadArticles by app.rssRepository.unreadArticles.collectAsState(initial = emptyList())
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                ...
                actions = {
                    IconButton(onClick = {
                        scope.launch { app.rssRepository.markAllAsRead() }
                    }) {
